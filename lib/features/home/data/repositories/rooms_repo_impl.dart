...
class RoomsRepoImpl implements RoomsRepoContract {
  ...
  Future<BaseResponse<RoomEntity>> createRoom({
    ...
    final response = await _dataSourceContract.createRoom(room);
  ...
  @override
  Future<BaseResponse<List<RoomEntity>>> getRooms() async {
    final response = await _dataSourceContract.getRooms();
